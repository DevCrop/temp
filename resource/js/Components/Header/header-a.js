function header() {
  ...
  // Helper function to check if it's the main page or about page
  function isMainPageOrAboutPage() {
    const path = window.location.pathname;
    return path === "/" || path === "/pages/about/about.php";
  }
